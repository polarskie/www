...
$("text.lv"+zoomlevel).attr("style","font-size:"+10/zoomlevel);
}
function smaller()
{
...
centerx=(window.pageXOffset+window.innerWidth/2)/zoomspeed-window.innerWidth/2;
centery=(window.pageYOffset+window.innerHeight/2)/zoomspeed-window.innerHeight/2;
$("text.lv"+zoomlevel).attr("style","font-size:0");
mapw /= zoomspeed;
maph /= zoomspeed;
zoom /= zoomspeed;
map.style.width = mapw+"px";
...
map.style.height = maph+"px";
zoomlevel = 1;
$("text.lv1").attr("style","font-size:10");
}
function put(event)
{
...
function show()
{
	...
	t.setAttribute("style","font-size:0");
	t.setAttribute("x", shopEvents[i+2]);
	t.setAttribute("y", shopEvents[i+3]);
	t.setAttribute("detailindex", i+4);
