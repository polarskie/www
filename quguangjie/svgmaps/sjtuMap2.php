...
function changeText(lv,sorb)
{
	if(lv==1) {
		...
		{
			lv2[i].style.fontSize=0;
		}
	}
	else if(lv==2) {
		for(var i=0;i<lv1.length;++i)
		{
			lv1[i].style.fontSize=fs2;
		}
		for(var i=0;i<lv2.length;++i)
		{
			lv2[i].style.fontSize=fs2;
		}
		if(sorb=="s")
			for(var i=0;i<lv3.length;++i)
			{
				lv3[i].style.fontSize=0;
			}
	}
	else if(lv==3) {
		for(var i=0;i<lv1.length;++i)
		{
			lv1[i].style.fontSize=fs3;
		}
		for(var i=0;i<lv2.length;++i)
		{
			lv2[i].style.fontSize=fs3;
		}
		for(var i=0;i<lv3.length;++i)
		{
			lv3[i].style.fontSize=fs3;
		}
		if(sorb=="s")
			for(var i=0;i<lv4.length;++i)
			{
				lv4[i].style.fontSize=0;
			}
	}
	else if(lv==4) {
		for(var i=0;i<lv1.length;++i)
		{
			lv1[i].style.fontSize=fs4;
		}
		for(var i=0;i<lv2.length;++i)
		{
			lv2[i].style.fontSize=fs4;
		}
		for(var i=0;i<lv3.length;++i)
		{
			lv3[i].style.fontSize=fs4;
		}
		for(var i=0;i<lv4.length;++i)
		{
			lv4[i].style.fontSize=fs4;
		}
		if(sorb=="s")
			for(var i=0;i<lv5.length;++i)
			{
				lv5[i].style.fontSize=0;
			}
	}
	else if(lv==5) {
		for(var i=0;i<lv1.length;++i)
		{
			lv1[i].style.fontSize=fs5;
		}
		for(var i=0;i<lv2.length;++i)
		{
			lv2[i].style.fontSize=fs5;
		}
		for(var i=0;i<lv3.length;++i)
		{
			lv3[i].style.fontSize=fs5;
		}
		for(var i=0;i<lv4.length;++i)
		{
			lv4[i].style.fontSize=fs5;
		}
		for(var i=0;i<lv5.length;++i)
		{
			lv5[i].style.fontSize=fs5;
		}
	}
}
function bigger1()
...
if(isset($_POST['aim']))
	{
		...
		if(!isset($_SESSION['aimArray'])) $_SESSION['aimArray']=array();
		$aimCount=count($_SESSION['aimArray']);
		$_SESSION['aimArray'][$aimCount++]=$row['shopName'];
		$_SESSION['aimArray'][$aimCount++]=$row['shopCoordinateX'];
		$_SESSION['aimArray'][$aimCount++]=$row['shopCoordinateY'];
		for($i=0;$i<$aimCount/3;++$i)
		{
			echo "aim[" . $i*3 . "]=\"" . $_SESSION['aimArray'][$i*3] . "\";
			aim[" . $i*3+1 . "]=" . $_SESSION['aimArray'][$i*3+1] . ";
			aim[" . $i*3+2 . "]=" . $_SESSION['aimArray'][$i*3+2] . ";";
		}
	}
?>
</script>
